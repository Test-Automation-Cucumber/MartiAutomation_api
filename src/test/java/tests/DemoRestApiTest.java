...
public class DemoRestApiTest extends TestBase {
	...
	Provider provider;
	 ...
	 /* 1. Verify that the API starts with an empty store.
	  ...
	  @Test (priority = 0, retryAnalyzer = utilities.RetryTest.class)
	  ...
	  required.*/
	  @Test (priority = 1, retryAnalyzer = utilities.RetryTest.class)
	  ...
	  be empty.*/
	  @Test (priority = 2, retryAnalyzer = utilities.RetryTest.class)
	  ...
	  @Test (priority = 3, retryAnalyzer = utilities.RetryTest.class)
	  ...
	  @Test (priority = 4, retryAnalyzer = utilities.RetryTest.class)
...
title and author already exists.*/
	  @Test (priority = 5, retryAnalyzer = utilities.RetryTest.class)
	  public void smilar() {
